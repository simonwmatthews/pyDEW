...
static const double H_TrPr = -6321234.41;
static const double S_TrPr = 583.2;
static const double k0 = 1229.233;
static const double k1 = -10256.5;
static const double k2 = -12276900.0;
static const double k3 = 2121510000.0;
static const double k5 = 0.0;
static const double k6 = 0.0;
static const double V_TrPr = 21.34;
...
const char *CHAMOSITE_dewminerals_identifier(void) {
    return identifier;
}

const char *CHAMOSITE_dewminerals_name(void) {
    return "CHAMOSITE";
}

const char *CHAMOSITE_dewminerals_formula(void) {
    return "Fe5Al2Si3O18H8";
}

const double CHAMOSITE_dewminerals_mw(void) {
    return 713.5069800000001;
}
...
const double *CHAMOSITE_dewminerals_elements(void) {
    return elmformula;
}
