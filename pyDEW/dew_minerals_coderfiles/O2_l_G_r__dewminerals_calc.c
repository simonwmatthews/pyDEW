...
static const double S_TrPr = 205.15;
static const double k0 = 23.10248;
static const double k1 = 804.8876;
static const double k2 = 1762835.0;
static const double k3 = 0.0;
static const double k5 = 0.002676;
static const double k6 = -18172.9196;
...
const char *O2_l_G_r__dewminerals_identifier(void) {
    return identifier;
}

const char *O2_l_G_r__dewminerals_name(void) {
    return "O2_l_G_r_";
}

const char *O2_l_G_r__dewminerals_formula(void) {
    return "O2";
}

const double O2_l_G_r__dewminerals_mw(void) {
    return 31.9988;
}
...
const double *O2_l_G_r__dewminerals_elements(void) {
    return elmformula;
}
