...
static const double H_TrPr = 147327.34;
static const double S_TrPr = 228.07;
static const double k0 = 36.48;
static const double k1 = 0.0;
static const double k2 = -376560.0;
static const double k3 = 0.0;
static const double k5 = 0.000669;
...
const char *S2_l_G_r__dewminerals_identifier(void) {
    return identifier;
}

const char *S2_l_G_r__dewminerals_name(void) {
    return "S2_l_G_r_";
}

const char *S2_l_G_r__dewminerals_formula(void) {
    return "S2";
}

const double S2_l_G_r__dewminerals_mw(void) {
    return 64.12;
}
...
const double *S2_l_G_r__dewminerals_elements(void) {
    return elmformula;
}
