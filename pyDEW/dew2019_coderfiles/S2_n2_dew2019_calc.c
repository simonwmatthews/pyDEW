...
static const double G_ref = 79496.0;
static const double S_ref = 28.4512;
static const double a1 = 4.266630949864;
static const double a2 = -2580.7856387376;
static const double a3 = 6.4625932789760006;
static const double a4 = -105604.39217016;
static const double c1 = -14.015140708048;
static const double c2 = -681801.6811368001;
static const double Psi = 2600.0;
static const double eta = 694657.0;
static const double rH = 3.082;
static const double omega0 = 1300512.72;
...
const char *S2_n2_dew2019_identifier(void) {
    return identifier;
}

const char *S2_n2_dew2019_name(void) {
    return "S2_n2";
}

const char *S2_n2_dew2019_formula(void) {
    return "S2";
}

const double S2_n2_dew2019_mw(void) {
    return 64.12;
}
...
const double *S2_n2_dew2019_elements(void) {
    return elmformula;
}
