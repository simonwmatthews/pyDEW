...
static const double G_ref = -699807.4720000001;
static const double S_ref = 185.7696;
...
static const double c1 = 209.20000000000002;
static const double c2 = -619232.0;
static const double Psi = 2600.0;
static const double eta = 694657.0;
static const double rH = 3.082;
static const double omega0 = 400366.95999999996;
...
const char *GLUTAMATE_n_dew2019_identifier(void) {
    return identifier;
}

const char *GLUTAMATE_n_dew2019_name(void) {
    return "GLUTAMATE_n";
}

const char *GLUTAMATE_n_dew2019_formula(void) {
    return "C5H8NO4";
}

const double GLUTAMATE_n_dew2019_mw(void) {
    return 146.12249999999997;
}
...
const double *GLUTAMATE_n_dew2019_elements(void) {
    return elmformula;
}
