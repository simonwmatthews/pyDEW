...
const char *GLUTARIC_l_AQ_r__dew2019_identifier(void) {
    return identifier;
}

const char *GLUTARIC_l_AQ_r__dew2019_name(void) {
    return "GLUTARIC_l_AQ_r_";
}

const char *GLUTARIC_l_AQ_r__dew2019_formula(void) {
    return "C5H8O4";
}

const double GLUTARIC_l_AQ_r__dew2019_mw(void) {
...
const double *GLUTARIC_l_AQ_r__dew2019_elements(void) {
    return elmformula;
}
