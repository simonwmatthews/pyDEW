...
const char *C2H5COOH_l_AQ_r__dew2019_identifier(void) {
    return identifier;
}

const char *C2H5COOH_l_AQ_r__dew2019_name(void) {
    return "C2H5COOH_l_AQ_r_";
}

const char *C2H5COOH_l_AQ_r__dew2019_formula(void) {
    return "C3H6O2";
}

const double C2H5COOH_l_AQ_r__dew2019_mw(void) {
    return 74.0792;
}
...
const double *C2H5COOH_l_AQ_r__dew2019_elements(void) {
    return elmformula;
}
