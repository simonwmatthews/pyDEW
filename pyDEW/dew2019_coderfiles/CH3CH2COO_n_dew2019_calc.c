...
static const double a1 = 3.5056141757928;
...
const char *CH3CH2COO_n_dew2019_identifier(void) {
    return identifier;
}

const char *CH3CH2COO_n_dew2019_name(void) {
    return "CH3CH2COO_n";
}

const char *CH3CH2COO_n_dew2019_formula(void) {
    return "C3H5O2";
}

const double CH3CH2COO_n_dew2019_mw(void) {
...
const double *CH3CH2COO_n_dew2019_elements(void) {
    return elmformula;
}
