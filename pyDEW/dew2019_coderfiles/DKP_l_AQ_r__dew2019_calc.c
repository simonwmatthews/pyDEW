...
const char *DKP_l_AQ_r__dew2019_identifier(void) {
    return identifier;
}

const char *DKP_l_AQ_r__dew2019_name(void) {
    return "DKP_l_AQ_r_";
}

const char *DKP_l_AQ_r__dew2019_formula(void) {
    return "C4H6O2N2";
}

const double DKP_l_AQ_r__dew2019_mw(void) {
    return 114.1036;
}
...
const double *DKP_l_AQ_r__dew2019_elements(void) {
    return elmformula;
}
