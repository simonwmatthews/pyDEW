...
const char *GLUTAMIC_l_AQ_r__dew2019_identifier(void) {
    return identifier;
}

const char *GLUTAMIC_l_AQ_r__dew2019_name(void) {
    return "GLUTAMIC_l_AQ_r_";
}

const char *GLUTAMIC_l_AQ_r__dew2019_formula(void) {
    return "C5H9NO4";
}

const double GLUTAMIC_l_AQ_r__dew2019_mw(void) {
...
const double *GLUTAMIC_l_AQ_r__dew2019_elements(void) {
    return elmformula;
}
