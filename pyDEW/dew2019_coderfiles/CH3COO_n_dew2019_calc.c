...
static const double a1 = 4.1915312;
static const double a2 = 1175.2856000000002;
...
const char *CH3COO_n_dew2019_identifier(void) {
    return identifier;
}

const char *CH3COO_n_dew2019_name(void) {
    return "CH3COO_n";
}

const char *CH3COO_n_dew2019_formula(void) {
    return "C2H3O2";
}

const double CH3COO_n_dew2019_mw(void) {
    return 59.0445;
}
...
const double *CH3COO_n_dew2019_elements(void) {
    return elmformula;
}
