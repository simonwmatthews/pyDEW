...
static const double G_ref = 65688.8;
static const double S_ref = 140.5824;
static const double a1 = 6.8480416514239995;
static const double a2 = -1845.0318131528;
static const double a3 = -12.279943588088;
static const double a4 = -108645.9985004;
static const double c1 = 23.162894750824;
static const double c2 = -498560.5292392;
static const double Psi = 2600.0;
static const double eta = 694657.0;
static const double rH = 3.082;
static const double omega0 = 1131813.8399999999;
...
const char *S5_n2_dew2019_identifier(void) {
    return identifier;
}

const char *S5_n2_dew2019_name(void) {
    return "S5_n2";
}

const char *S5_n2_dew2019_formula(void) {
    return "S5";
}

const double S5_n2_dew2019_mw(void) {
    return 160.3;
}
...
const double *S5_n2_dew2019_elements(void) {
    return elmformula;
}
