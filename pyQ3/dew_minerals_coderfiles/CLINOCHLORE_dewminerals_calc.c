...
static const double H_TrPr = -8120804.2;
static const double S_TrPr = 435.1545;
static const double k0 = 1214.28442;
static const double k1 = -11217.129;
static const double k2 = 0.0;
static const double k3 = -1256253184.0;
static const double k5 = 0.0;
static const double k6 = 0.0;
static const double V_TrPr = 21.147;
static const double v1 = -1.8194707000000001e-06;
static const double v2 = 0.0;
static const double v3 = 2.64515406e-05;
...
const char *CLINOCHLORE_dewminerals_identifier(void) {
    return identifier;
}

const char *CLINOCHLORE_dewminerals_name(void) {
    return "CLINOCHLORE";
}

const char *CLINOCHLORE_dewminerals_formula(void) {
    return "Mg5Al2Si3O18H8";
}

const double CLINOCHLORE_dewminerals_mw(void) {
    return 555.7969800000001;
}
...
const double *CLINOCHLORE_dewminerals_elements(void) {
    return elmformula;
}
