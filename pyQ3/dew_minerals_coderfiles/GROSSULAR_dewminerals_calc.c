...
static const double H_TrPr = -2064972.596035;
static const double S_TrPr = 85.05;
static const double k0 = 191.1434733;
static const double k1 = -679.8016667;
static const double k2 = -6295722.667;
static const double k3 = 773103957.3;
static const double k5 = 0.0;
static const double k6 = 0.0;
static const double V_TrPr = 4.179333333;
static const double v1 = -2.1797120000000002e-07;
static const double v2 = 5.45e-13;
static const double v3 = 6.33140057e-06;
static const double v4 = 2.65853e-09;
...
const char *GROSSULAR_dewminerals_identifier(void) {
    return identifier;
}

const char *GROSSULAR_dewminerals_name(void) {
    return "GROSSULAR";
}

const char *GROSSULAR_dewminerals_formula(void) {
    return "Ca1.001Al0.666SiO4";
}

const double GROSSULAR_dewminerals_mw(void) {
    return 150.17288564;
}
...
const double *GROSSULAR_dewminerals_elements(void) {
    return elmformula;
}
