...
static const double H_TrPr = 38962.242;
static const double S_TrPr = 130.574;
static const double k0 = 27.28;
static const double k1 = 0.0;
static const double k2 = -50208.0;
static const double k3 = 0.0;
static const double k5 = 0.003263;
...
const char *H2_l_G_r__dewminerals_identifier(void) {
    return identifier;
}

const char *H2_l_G_r__dewminerals_name(void) {
    return "H2_l_G_r_";
}

const char *H2_l_G_r__dewminerals_formula(void) {
    return "H2";
}

const double H2_l_G_r__dewminerals_mw(void) {
    return 2.0158;
}
...
const double *H2_l_G_r__dewminerals_elements(void) {
    return elmformula;
}
