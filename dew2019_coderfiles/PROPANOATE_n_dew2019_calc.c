...
static const char *identifier = "Tue May  4 13:25:09 2021";

static const double T_r = 298.15;
static const double P_r = 1.0;
static const double G_ref = -363045.68;
static const double S_ref = 110.876;
static const double a1 = 3.5056141757928003;
static const double a2 = 8090.395340496001;
static const double a3 = 0.19237246244800002;
static const double a4 = -149719.0543552;
static const double c1 = 218.82319999999999;
static const double c2 = -175728.0;
static const double Psi = 2600.0;
static const double eta = 694657.0;
static const double rH = 3.082;
static const double omega0 = 513627.84;
...
const char *PROPANOATE_n_dew2019_identifier(void) {
    return identifier;
}

const char *PROPANOATE_n_dew2019_name(void) {
    return "PROPANOATE_n";
}

const char *PROPANOATE_n_dew2019_formula(void) {
    return "C3H5O2";
}

const double PROPANOATE_n_dew2019_mw(void) {
    return 73.07130000000001;
}
...
const double *PROPANOATE_n_dew2019_elements(void) {
    return elmformula;
}

double PROPANOATE_n_dew2019_g(double T, double P) {
    return dew2019_g(T, P);
}

double PROPANOATE_n_dew2019_dgdt(double T, double P) {
    return dew2019_dgdt(T, P);
}

double PROPANOATE_n_dew2019_dgdp(double T, double P) {
    return dew2019_dgdp(T, P);
}

double PROPANOATE_n_dew2019_d2gdt2(double T, double P) {
    return dew2019_d2gdt2(T, P);
}

double PROPANOATE_n_dew2019_d2gdtdp(double T, double P) {
    return dew2019_d2gdtdp(T, P);
}

double PROPANOATE_n_dew2019_d2gdp2(double T, double P) {
    return dew2019_d2gdp2(T, P);
}

double PROPANOATE_n_dew2019_d3gdt3(double T, double P) {
    return dew2019_d3gdt3(T, P);
}

double PROPANOATE_n_dew2019_d3gdt2dp(double T, double P) {
    return dew2019_d3gdt2dp(T, P);
}

double PROPANOATE_n_dew2019_d3gdtdp2(double T, double P) {
    return dew2019_d3gdtdp2(T, P);
}

double PROPANOATE_n_dew2019_d3gdp3(double T, double P) {
    return dew2019_d3gdp3(T, P);
}

double PROPANOATE_n_dew2019_s(double T, double P) {
    return dew2019_s(T, P);
}

double PROPANOATE_n_dew2019_v(double T, double P) {
    return dew2019_v(T, P);
}

double PROPANOATE_n_dew2019_cv(double T, double P) {
    return dew2019_cv(T, P);
}

double PROPANOATE_n_dew2019_cp(double T, double P) {
    return dew2019_cp(T, P);
}

double PROPANOATE_n_dew2019_dcpdt(double T, double P) {
    return dew2019_dcpdt(T, P);
}

double PROPANOATE_n_dew2019_alpha(double T, double P) {
    return dew2019_alpha(T, P);
}

double PROPANOATE_n_dew2019_beta(double T, double P) {
    return dew2019_beta(T, P);
}

double PROPANOATE_n_dew2019_K(double T, double P) {
    return dew2019_K(T, P);
}

double PROPANOATE_n_dew2019_Kp(double T, double P) {
