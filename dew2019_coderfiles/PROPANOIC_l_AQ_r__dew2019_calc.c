...
const char *PROPANOIC_l_AQ_r__dew2019_identifier(void) {
    return identifier;
}

const char *PROPANOIC_l_AQ_r__dew2019_name(void) {
    return "PROPANOIC_l_AQ_r_";
}

const char *PROPANOIC_l_AQ_r__dew2019_formula(void) {
    return "C3H6O2";
}

const double PROPANOIC_l_AQ_r__dew2019_mw(void) {
    return 74.0792;
}
...
const double *PROPANOIC_l_AQ_r__dew2019_elements(void) {
    return elmformula;
}
