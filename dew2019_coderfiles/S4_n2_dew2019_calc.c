...
static const double G_ref = 69036.0;
static const double S_ref = 103.3448;
static const double a1 = 5.990775594504;
static const double a2 = -2089.3698338368;
static const double a3 = -6.055695467352001;
static const double a4 = -107635.90508632001;
static const double c1 = 10.912964848248;
static const double c2 = -559077.7671672;
static const double Psi = 2600.0;
static const double eta = 694657.0;
static const double rH = 3.082;
static const double omega0 = 1187837.6;
...
const char *S4_n2_dew2019_identifier(void) {
    return identifier;
}

const char *S4_n2_dew2019_name(void) {
    return "S4_n2";
}

const char *S4_n2_dew2019_formula(void) {
    return "S4";
}

const double S4_n2_dew2019_mw(void) {
    return 128.24;
}
...
const double *S4_n2_dew2019_elements(void) {
    return elmformula;
}
