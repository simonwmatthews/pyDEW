...
static const double G_ref = -2009993.6;
static const double S_ref = 163.17600000000002;
static const double a1 = 5.420191351616;
static const double a2 = 3368.4956457960006;
static const double a3 = -8.001903230047999;
static const double a4 = -130198.72101344001;
static const double c1 = 77.0859026136;
static const double c2 = -299977.6311172;
static const double Psi = 2600.0;
static const double eta = 694657.0;
static const double rH = 3.082;
static const double omega0 = 1096961.1199999999;
...
const char *H2P2O7_n2_dew2019_identifier(void) {
    return identifier;
}

const char *H2P2O7_n2_dew2019_name(void) {
    return "H2P2O7_n2";
}

const char *H2P2O7_n2_dew2019_formula(void) {
    return "H2P2O7";
}

const double H2P2O7_n2_dew2019_mw(void) {
    return 175.95911999999998;
}
...
const double *H2P2O7_n2_dew2019_elements(void) {
    return elmformula;
}
