...
const char *DIKETOPIP_l_AQ_r__dew2019_identifier(void) {
    return identifier;
}

const char *DIKETOPIP_l_AQ_r__dew2019_name(void) {
    return "DIKETOPIP_l_AQ_r_";
}

const char *DIKETOPIP_l_AQ_r__dew2019_formula(void) {
    return "C4H6O2N2";
}

const double DIKETOPIP_l_AQ_r__dew2019_mw(void) {
    return 114.1036;
}
...
const double *DIKETOPIP_l_AQ_r__dew2019_elements(void) {
    return elmformula;
}
