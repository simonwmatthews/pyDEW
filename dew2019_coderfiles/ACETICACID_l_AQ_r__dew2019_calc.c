...
static const char *identifier = "Wed May  5 10:05:22 2021";
...
const char *ACETICACID_l_AQ_r__dew2019_identifier(void) {
    return identifier;
}

const char *ACETICACID_l_AQ_r__dew2019_name(void) {
    return "ACETICACID_l_AQ_r_";
}

const char *ACETICACID_l_AQ_r__dew2019_formula(void) {
    return "C2H4O2";
}

const double ACETICACID_l_AQ_r__dew2019_mw(void) {
    return 60.0524;
}
...
const double *ACETICACID_l_AQ_r__dew2019_elements(void) {
    return elmformula;
}
