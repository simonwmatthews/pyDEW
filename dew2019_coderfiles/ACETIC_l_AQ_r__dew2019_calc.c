...
const char *ACETIC_l_AQ_r__dew2019_identifier(void) {
    return identifier;
}

const char *ACETIC_l_AQ_r__dew2019_name(void) {
    return "ACETIC_l_AQ_r_";
}

const char *ACETIC_l_AQ_r__dew2019_formula(void) {
    return "C2H4O2";
}

const double ACETIC_l_AQ_r__dew2019_mw(void) {
    return 60.0524;
}
...
const double *ACETIC_l_AQ_r__dew2019_elements(void) {
    return elmformula;
}
