...
static const char *identifier = "Tue May  4 13:25:03 2021";

static const double T_r = 298.15;
static const double P_r = 1.0;
static const double G_ref = -369321.68;
static const double S_ref = 86.19040000000001;
static const double a1 = 4.191531199999999;
static const double a2 = 1175.2856;
static const double a3 = 28.11648;
static const double a4 = -121089.144;
static const double c1 = 110.03920000000001;
static const double c2 = -161502.4;
static const double Psi = 2600.0;
static const double eta = 694657.0;
static const double rH = 3.082;
static const double omega0 = 551534.88;
...
const char *ACETATE_l_AQ_r__dew2019_identifier(void) {
    return identifier;
}

const char *ACETATE_l_AQ_r__dew2019_name(void) {
    return "ACETATE_l_AQ_r_";
}

const char *ACETATE_l_AQ_r__dew2019_formula(void) {
    return "C2H3O2";
}

const double ACETATE_l_AQ_r__dew2019_mw(void) {
    return 59.0445;
}
...
const double *ACETATE_l_AQ_r__dew2019_elements(void) {
    return elmformula;
}

double ACETATE_l_AQ_r__dew2019_g(double T, double P) {
    return dew2019_g(T, P);
}

double ACETATE_l_AQ_r__dew2019_dgdt(double T, double P) {
    return dew2019_dgdt(T, P);
}

double ACETATE_l_AQ_r__dew2019_dgdp(double T, double P) {
    return dew2019_dgdp(T, P);
}

double ACETATE_l_AQ_r__dew2019_d2gdt2(double T, double P) {
    return dew2019_d2gdt2(T, P);
}

double ACETATE_l_AQ_r__dew2019_d2gdtdp(double T, double P) {
    return dew2019_d2gdtdp(T, P);
}

double ACETATE_l_AQ_r__dew2019_d2gdp2(double T, double P) {
    return dew2019_d2gdp2(T, P);
}

double ACETATE_l_AQ_r__dew2019_d3gdt3(double T, double P) {
    return dew2019_d3gdt3(T, P);
}

double ACETATE_l_AQ_r__dew2019_d3gdt2dp(double T, double P) {
    return dew2019_d3gdt2dp(T, P);
}

double ACETATE_l_AQ_r__dew2019_d3gdtdp2(double T, double P) {
    return dew2019_d3gdtdp2(T, P);
}

double ACETATE_l_AQ_r__dew2019_d3gdp3(double T, double P) {
    return dew2019_d3gdp3(T, P);
}

double ACETATE_l_AQ_r__dew2019_s(double T, double P) {
    return dew2019_s(T, P);
}

double ACETATE_l_AQ_r__dew2019_v(double T, double P) {
    return dew2019_v(T, P);
}

double ACETATE_l_AQ_r__dew2019_cv(double T, double P) {
    return dew2019_cv(T, P);
}

double ACETATE_l_AQ_r__dew2019_cp(double T, double P) {
    return dew2019_cp(T, P);
}

double ACETATE_l_AQ_r__dew2019_dcpdt(double T, double P) {
    return dew2019_dcpdt(T, P);
}

double ACETATE_l_AQ_r__dew2019_alpha(double T, double P) {
    return dew2019_alpha(T, P);
}

double ACETATE_l_AQ_r__dew2019_beta(double T, double P) {
    return dew2019_beta(T, P);
}

double ACETATE_l_AQ_r__dew2019_K(double T, double P) {
    return dew2019_K(T, P);
}

double ACETATE_l_AQ_r__dew2019_Kp(double T, double P) {
