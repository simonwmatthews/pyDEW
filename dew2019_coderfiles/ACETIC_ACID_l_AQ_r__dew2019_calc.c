...
static const char *identifier = "Wed May  5 10:33:44 2021";
...
const char *ACETIC_ACID_l_AQ_r__dew2019_identifier(void) {
    return identifier;
}

const char *ACETIC_ACID_l_AQ_r__dew2019_name(void) {
    return "ACETIC_ACID_l_AQ_r_";
}

const char *ACETIC_ACID_l_AQ_r__dew2019_formula(void) {
    return "C2H4O2";
}

const double ACETIC_ACID_l_AQ_r__dew2019_mw(void) {
    return 60.0524;
}
...
const double *ACETIC_ACID_l_AQ_r__dew2019_elements(void) {
    return elmformula;
}

double ACETIC_ACID_l_AQ_r__dew2019_g(double T, double P) {
    return dew2019_g(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_dgdt(double T, double P) {
    return dew2019_dgdt(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_dgdp(double T, double P) {
    return dew2019_dgdp(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_d2gdt2(double T, double P) {
    return dew2019_d2gdt2(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_d2gdtdp(double T, double P) {
    return dew2019_d2gdtdp(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_d2gdp2(double T, double P) {
    return dew2019_d2gdp2(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_d3gdt3(double T, double P) {
    return dew2019_d3gdt3(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_d3gdt2dp(double T, double P) {
    return dew2019_d3gdt2dp(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_d3gdtdp2(double T, double P) {
    return dew2019_d3gdtdp2(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_d3gdp3(double T, double P) {
    return dew2019_d3gdp3(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_s(double T, double P) {
    return dew2019_s(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_v(double T, double P) {
    return dew2019_v(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_cv(double T, double P) {
    return dew2019_cv(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_cp(double T, double P) {
    return dew2019_cp(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_dcpdt(double T, double P) {
    return dew2019_dcpdt(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_alpha(double T, double P) {
    return dew2019_alpha(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_beta(double T, double P) {
    return dew2019_beta(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_K(double T, double P) {
    return dew2019_K(T, P);
}

double ACETIC_ACID_l_AQ_r__dew2019_Kp(double T, double P) {
