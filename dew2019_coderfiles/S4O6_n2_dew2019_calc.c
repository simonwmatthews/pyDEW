...
static const double G_ref = -1040560.8;
static const double S_ref = 257.31600000000003;
static const double a1 = 9.534208838767999;
static const double a2 = -1079.420287852;
static const double a3 = -31.783073225592002;
static const double a4 = -111811.03651256;
static const double c1 = 61.476924351040005;
static const double c2 = -308503.82928688003;
static const double Psi = 2600.0;
static const double eta = 694657.0;
static const double rH = 3.082;
static const double omega0 = 954161.2;
...
const char *S4O6_n2_dew2019_identifier(void) {
    return identifier;
}

const char *S4O6_n2_dew2019_name(void) {
    return "S4O6_n2";
}

const char *S4O6_n2_dew2019_formula(void) {
    return "S4O6";
}

const double S4O6_n2_dew2019_mw(void) {
    return 224.2364;
}
...
const double *S4O6_n2_dew2019_elements(void) {
    return elmformula;
}
