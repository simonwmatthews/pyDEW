...
const char *H_SUCCINA_l_AQ_r__dew2019_identifier(void) {
    return identifier;
}

const char *H_SUCCINA_l_AQ_r__dew2019_name(void) {
    return "H_SUCCINA_l_AQ_r_";
}

const char *H_SUCCINA_l_AQ_r__dew2019_formula(void) {
    return "C4H5O4";
}

const double H_SUCCINA_l_AQ_r__dew2019_mw(void) {
...
const double *H_SUCCINA_l_AQ_r__dew2019_elements(void) {
    return elmformula;
}
