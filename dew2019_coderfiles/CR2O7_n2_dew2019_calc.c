...
static const double G_ref = -1301224.0;
static const double S_ref = 261.9184;
static const double a1 = 7.022584148496;
static const double a2 = 4894.1325463680005;
static const double a3 = -20.794224052168;
static const double a4 = -136505.70395184;
static const double c1 = 63.10247504400001;
static const double c2 = -300830.76762888;
static const double Psi = 2600.0;
static const double eta = 694657.0;
static const double rH = 3.082;
static const double omega0 = 947843.36;
...
const char *CR2O7_n2_dew2019_identifier(void) {
    return identifier;
}

const char *CR2O7_n2_dew2019_name(void) {
    return "CR2O7_n2";
}

const char *CR2O7_n2_dew2019_formula(void) {
    return "Cr2O7";
}

const double CR2O7_n2_dew2019_mw(void) {
    return 215.9878;
}
...
const double *CR2O7_n2_dew2019_elements(void) {
    return elmformula;
}
